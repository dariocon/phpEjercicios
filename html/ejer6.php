    ...
    if (isset($_GET['palabra1']) && isset($_GET['palabra2']) && !empty($_GET['palabra1']) && !empty($_GET['palabra2'])){
            ...
            if ((!preg_match("/^[A-Z]+$/", $palabra1Mayusculas)) || (!preg_match("/^[A-Z]+$/", $palabra2Mayusculas))) {
                ...
                if (strlen($palabra1Mayusculas) != strlen($palabra2Mayusculas)) {
                    ...
                    // con explode no se puede, que sirve más para separar por palabras
    
                    sort($arrayPalabra1Mayusculas);
                    sort($arrayPalabra2Mayusculas);
                    ...
                    if ($arrayPalabra1Mayusculas == $arrayPalabra2Mayusculas) {
                        echo "Es anagrama.";
                    } else {
                        echo "No es anagrama.";
                    }
...
<form method="GET" action="ejer6.php">
